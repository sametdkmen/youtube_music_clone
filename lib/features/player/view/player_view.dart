...
import 'package:youtube_music_clone/features/player/widget/like_button.dart';
import 'package:youtube_music_clone/features/player/widget/shortcut_button.dart';
...
class PlayerView extends StatefulWidget {
  ...
  const PlayerView({super.key, required this.model, required this.heroTag});
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            image: DecorationImage(
              fit: BoxFit.cover,
              image: AssetImage(
                "assets/images/covers/${widget.model.imageName}",
              ),
            ),
          ),
        ),
